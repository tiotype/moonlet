...
import mainImage from "../../assets/images/type/ultra.svg"
      ...
      <Layout>
        <Container fluid className="work">
          ...
          <Container fluid className="work-name-contain" id="specimen">
            <Row>
              <Col md={12}>
                <p className="work-name-header">Typeface 5</p>
              </Col>
            </Row>
          </Container>
          <Container className="work-grid">
            <Row>
              <Col md={12}>
                <img src={mainImage} alt="Typeface 5" />
              </Col>
            </Row>
          </Container>
          <Container className="work-desc" id="info">
            <Row>
              <Col md={12}>
                <p className="desc-name">Typeface 5</p>
